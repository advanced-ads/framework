...
abstract class Autoloader {
	 ...
	 * @return string
	 */
	abstract public function get_directory(): string;
	 ...
	 * @return void
	 */
	public function missing_autoloader(): void {
		?>
		<div class="notice notice-error">
			<p>
				...
				printf(
					...
					esc_html__( 'Your installation of Advanced Ads is incomplete. If you installed Advanced Ads from GitHub, %1$s please refer to this document%2$s to set up your development environment.' ),
